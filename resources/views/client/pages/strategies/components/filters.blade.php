    ...
    <div class="col-12">
        <form method="get">
                ...
                <div class="col-lg-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="name" class="form-control"
                            placeholder="{{ __('pages.client.strategies.filters.name') }}"
            ...
            <div class="btn-group">
                ...
                @if (role_can_permission('strategies.store'))
                    <a href="{{ route('client.strategies.create', $client->name) }}"
                        class="btn btn-danger btn-sm ml-2">{{ __('buttons.register') }}</a>
                @endif
            </div>
            <hr>
            <h6 class="font-weight-bold">{{ __('pages.client.strategies.filters.total') }}<a
