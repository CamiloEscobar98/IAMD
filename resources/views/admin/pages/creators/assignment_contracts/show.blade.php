...
@section('content')
    <div class="container-fluid">
        ...
        <p>{!! __('pages.admin.creators.assignment_contracts.info.show', ['assignment_contract' => $item->name]) !!}</p>

        <div class="bg-danger text-white pl-3 py-2">
            <h5 class="font-weight-bold">{{ __('pages.admin.creators.assignment_contracts.form-titles.show') }}</h5>
        </div>
        ...
        <div class="form-group mt-3">
            <a href="{{ route('admin.creators.assignment_contracts.edit', $item->id) }}"
