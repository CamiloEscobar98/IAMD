        ...
        <div class="col-12">
            <form method="get">
                    ...
                    <div class="col-lg-3">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="name" class="form-control"
                                placeholder="{{ __('pages.admin.intellectual_property_rights.categories.filters.name') }}"
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ route('admin.intellectual_property_rights.categories.create') }}"
                        class="btn btn-dark btn-sm ml-2">{{ __('buttons.register') }}</a>
                </div>
                <hr>
                <h6 class="font-weight-bold">{{ __('pages.admin.intellectual_property_rights.categories.filters.total') }}<a
