...
@section('title', __('pages.admin.localizations.states.route-titles.edit'))
...
@section('content')
    <div class="container-fluid">
        ...
        <p>{!! __('pages.admin.localizations.states.info.edit', ['state' => $item->name]) !!}</p>

        <div class="card">
            <div class="card-header bg-gradient-danger">
                <h5 class="font-weight-bold">{{ __('pages.admin.localizations.states.form-titles.update') }}</h5>
            </div>
            <div class="card-body">
