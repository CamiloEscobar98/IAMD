        ...
        <table class="table table-sm table-bordered border-1">
            <tbody>
                <tr class="text-center">
                    <td colspan="3" class="bg-title text-white font-weight-bold">Reporte Personalizado Activos Intangibles
                    </td>
                </tr>

                @if (hasContent($generalConfiguration, 'with_general_total'))
                    <!-- Total -->
                    <tr class="text-center">
                ...
                @if (hasContent($generalConfiguration, 'with_general_phase_status'))
                    <!-- Completed Phases -->
                    <tr class="text-center">
