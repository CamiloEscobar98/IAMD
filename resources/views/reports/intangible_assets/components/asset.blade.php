<table class="table table-sm table-bordered border-1 mt-4">
    <tbody>
        ...
        <tr class="text-center">
            <td>
                <small class="font-weight-bold">Unidad de Investigación:</small>
                @forelse ($intangibleAsset->research_units as $researchUnit)
                    <small>{{ $researchUnit->name }}</small>
                @empty
    ...
    <tbody>
        ...
        @if ($intangibleAsset->hasPriorityTools())
            @foreach ($intangibleAsset->dpis as $intangibleAssetDpi)
                <tr class="text-center">
                    <td colspan="3">
                        <small class="font-weight-bold">Herramientas de Priorización para el Derecho de
                            Propiedad
