...
class DocumentTypeController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        try {
            ...
            return back()->with('alert', ['title' => __('messages.success'), 'icon' => 'success', 'text' => __('admin_pages.document_types.messages.save_success', ['document_type' => $item->name])]);
        } catch (\Exception $th) {
            return back()->with('alert', ['title' => __('messages.error'), 'icon' => 'error', 'text' => __('admin_pages.document_types.messages.save_error')]);
        }
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        try {
            ...
            return back()->with('alert', ['title' => __('messages.success'), 'icon' => 'success', 'text' => __('admin_pages.document_types.messages.update_success', ['document_type' => $item->name])]);
        } catch (\Exception $th) {
            return back()->with('alert', ['title' => __('messages.error'), 'icon' => 'error', 'text' => __('admin_pages.document_types.messages.update_error')]);
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return back()->with('alert', ['title' => __('messages.success'), 'icon' => 'success', 'text' => __('admin_pages.document_types.messages.delete_success', ['document_type' => $item->name])]);
        } catch (\Exception $th) {
            return back()->with('alert', ['title' => __('messages.error'), 'icon' => 'error', 'text' => __('admin_pages.document_types.messages.delete_error')]);
        }
    }
}
