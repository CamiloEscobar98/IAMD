...
class ExternalOrganizationController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        try {
            ...
            return back()->with('alert', ['title' => __('messages.success'), 'icon' => 'success', 'text' => __('admin_pages.creators.external_organizations.messages.save_success', ['external_organization' => $item->name])]);
        } catch (\Exception $th) {
            return back()->with('alert', ['title' => __('messages.error'), 'icon' => 'error', 'text' => __('admin_pages.creators.external_organizations.messages.save_error')]);
        }
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        try {
            ...
            return back()->with('alert', ['title' => __('messages.success'), 'icon' => 'success', 'text' => __('admin_pages.creators.external_organizations.messages.update_success', ['external_organization' => $item->name])]);
        } catch (\Exception $th) {
            return back()->with('alert', ['title' => __('messages.error'), 'icon' => 'error', 'text' => __('admin_pages.creators.external_organizations.messages.update_error')]);
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return back()->with('alert', ['title' => __('messages.success'), 'icon' => 'success', 'text' => __('admin_pages.creators.external_organizations.messages.delete_success', ['external_organization' => $item->name])]);
        } catch (\Exception $th) {
            return back()->with('alert', ['title' => __('messages.error'), 'icon' => 'error', 'text' => __('admin_pages.creators.external_organizations.messages.delete_error')]);
        }
    }
}
